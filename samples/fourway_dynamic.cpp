//===-- samples/fourway_dynamic.cpp - Dynamic Search Example --------------===//
//
...
int main(int argc, char* argv[])
{
    ...
    Utility::loadMazeFromFile(reference_maze, maze_filename);
    ...
    //
    FourWayStepMapGraph mg(virtual_maze);
    ...
    //
    FourWayStepMapGraph<false> mg_fast_run(virtual_maze);
    // ソルバのグラフ表現を入れ替えます．
    //
